...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.100.100.107/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| FLOOR2 | Vlan4094 | 192.168.1.5 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SPL1_Ethernet5 | *trunk | *none | *- | *- | 1 |
| Ethernet2 | SPL2_Ethernet5 | *trunk | *none | *- | *- | 1 |
| Ethernet3 | MLAG_PEER_L2L2B_Ethernet3 | *trunk | *2-4094 | *- | *['MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_L2L2B_Ethernet4 | *trunk | *2-4094 | *- | *['MLAG'] | 3 |
...
!
interface Ethernet1
   description SPL1_Ethernet5
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SPL2_Ethernet5
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description MLAG_PEER_L2L2B_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_L2L2B_Ethernet4
   no shutdown
   channel-group 3 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | SPLINE_Po5 | switched | trunk | none | - | - | - | - | 1 | - |
| Port-Channel3 | MLAG_PEER_L2L2B_Po3 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_L2L2B_Po3
   no shutdown
   switchport
