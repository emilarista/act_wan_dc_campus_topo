...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_EL1_Ethernet2 | routed | - | 100.64.2.2/31 | default | 9000 | False | - | - |
| Ethernet2 | P2P_LINK_TO_EL2_Ethernet2 | routed | - | 100.64.2.8/31 | default | 9000 | False | - | - |
| Ethernet3 | P2P_LINK_TO_L1A_Ethernet2 | routed | - | 100.64.2.14/31 | default | 9000 | False | - | - |
| Ethernet4 | P2P_LINK_TO_L1B_Ethernet2 | routed | - | 100.64.2.20/31 | default | 9000 | False | - | - |
| Ethernet5 | P2P_LINK_TO_L2A_Ethernet2 | routed | - | 100.64.2.26/31 | default | 9000 | False | - | - |
| Ethernet6 | P2P_LINK_TO_L2B_Ethernet2 | routed | - | 100.64.2.32/31 | default | 9000 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.0.2/32 |
...
| 100.64.2.3 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.2.9 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.2.15 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.2.21 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.2.27 | 65104 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.2.33 | 65104 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
router bgp 65101
   ...
   neighbor 100.64.2.3 remote-as 65102
   neighbor 100.64.2.3 description EL1_Ethernet2
   neighbor 100.64.2.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.2.9 remote-as 65102
   neighbor 100.64.2.9 description EL2_Ethernet2
   neighbor 100.64.2.15 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.2.15 remote-as 65103
   neighbor 100.64.2.15 description L1A_Ethernet2
   neighbor 100.64.2.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.2.21 remote-as 65103
   neighbor 100.64.2.21 description L1B_Ethernet2
   neighbor 100.64.2.27 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.2.27 remote-as 65104
   neighbor 100.64.2.27 description L2A_Ethernet2
   neighbor 100.64.2.33 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.2.33 remote-as 65104
   neighbor 100.64.2.33 description L2B_Ethernet2
